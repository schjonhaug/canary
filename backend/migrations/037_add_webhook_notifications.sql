-- Migration 037: Self-hosted JSON webhook notification provider support
...
CREATE TABLE contact_notification_methods_new (
    ...
    provider_type TEXT NOT NULL CHECK (provider_type IN ('sms', 'ntfy', 'email', 'nostr', 'webhook')),
...
-- Webhook endpoints may intentionally be shared by multiple contacts.
