...
use crate::handlers::{
    create_wallet_balance_alert, create_wallet_contact, create_wallet_non_blocking,
    delete_balance_alert, delete_wallet, delete_wallet_contact, get_current_block_header,
    get_exchange_rates, get_providers, get_user_preferences, get_wallet, get_wallet_balance_alerts,
    get_wallet_contacts, get_wallet_detail, get_wallets_list, send_contact_verification,
    update_user_preferences, update_wallet, update_wallet_contact, verify_contact,
};
use crate::auth::{
...
use crate::models::{
    ...
    CreateCheckoutSessionRequest, CreateCustomerPortalRequest, ErrorResponse,
};
